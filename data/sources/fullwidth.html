...
<html>
	...
	<body id="fullwidth">
		<div id="wrapper">
			...
			<section>
			<h1>No Sidebar Page</h1>
			<img src="images/banner.jpg" />
			<h2 class="mg">Headings</h2>
			<h1>This is the heading 1</h1>
			<h2>This is the heading 2</h2>
			<h3>This is the heading 3</h3>
			<h4>This is the heading 4</h4>
			<h5>This is the heading 5</h5>
			<h6>This is the heading 6</h6>
			<h2 class="mg">Text</h2>
				  <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor
				  incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud
				  exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute
				  irure dolor in reprehenderit in voluptate velit esse cillum. Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor
				  incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud
				  exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute
			 ...
			 <h2 class="mg">Lists</h2>
				<p class="mg">This is an unordered list:</p>
				<ul>
				  <li>Item 1</li>
				  <li>Item 2</li>
				  <li>Item 3</li>
				...
				<p class="mg">This is an ordered list:</p>
				<ol>
				  <li>Item 1</li>
				  <li>Item 2</li>
				  <li>Item 3</li>
				...
				<h2 class="mg">Images</h2>
				<p>images can be placed on the left, in the center or on the right:</p>
				<span class="left"><img src="images/float.jpg" alt="example float" /></span>
				<p>
				...
				<span class="center"><img src="images/float.jpg" alt="example float" /></span>
				<span class="right"><img src="images/float.jpg" alt="example float" /></span>
				<p>
				  Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor
				  incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud
				  exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute
